...
@section('MenuBar_AddCoupon','m-menu__item m-menu__item--active')
...
@section('titlePage','Mã giảm giá')
@section('headTitle','Mã giảm giá')
@section('typePage')
<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
	...
	<li class="m-nav__item">
		<a href="{{ route('spa_showAddCoupon') }}" class="m-nav__link">
			<span class="m-nav__link-text">
				Thêm mã giảm giá
			</span>
		</a>
	...
	<div class="row">
		<div class="col-xl-12">
			...
			<div class="m-portlet">
				...
				<!--begin::Form-->
				<form id="frmAddCoupon" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-3">
								<input type="text" name="couponcode" class="form-control m-input">
							...
							<div class="col-lg-3">
								<input type="text" name="coupondescription" class="form-control m-input">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-3">
								<input type="datetime-local" name="datestart" min="{{Carbon\Carbon::now()->format("Y-m-d\TH:i")}}" class="form-control m-input">
							...
							<div class="col-lg-3">
								<input type="datetime-local" name="dateexpired" min="{{Carbon\Carbon::now()->format("Y-m-d\TH:i")}}" class="form-control m-input">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-3">
								<input type="number" name="couponvalue" class="form-control m-input">
