						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<button class="btn btn-danger m-btn m-btn--icon btn-sm m-btn--icon-only  m-btn--pill" data-toggle="modal" data-target="#modal_del" data-url="{{route('spa_deleteStaff',['id'=>$value->StaffId])}}" data-title="{{$value->StaffName}}" title="Xoá">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">
					Xác nhận xoá nhân viên <b><span id="title-md-del"></span></b>
				</h5>
			</div>
