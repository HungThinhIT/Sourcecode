...
@section('MenuBar_AddRoom','m-menu__item m-menu__item--active')
...
<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
	...
	<li class="m-nav__item">
		<a href="{{ route('spa_showAddRoom') }}" class="m-nav__link">
			<span class="m-nav__link-text">
				Thêm mới phòng
			</span>
		</a>
				...
				<form id="frmAddRoom" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-3">
								<input type="text" name="roomname" class="form-control m-input">
