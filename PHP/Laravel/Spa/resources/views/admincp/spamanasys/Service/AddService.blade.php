...
@section('MenuBar_AddService','m-menu__item m-menu__item--active')
...
@section('titlePage','Tạo phòng')
@section('headTitle','Tạo phòng mới')
@section('typePage')
<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
	...
	<li class="m-nav__item">
		<a href="{{ route('spa_showAddService') }}" class="m-nav__link">
			<span class="m-nav__link-text">
				Thêm dịch vụ
			</span>
		</a>
	...
	<div class="row">
		<div class="col-xl-12">
			...
			<div class="m-portlet">
				...
				<!--begin::Form-->
				<form id="frmAddRoom" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
					<div class="m-portlet__body">
						<div class="form-group m-form__group">
							<div class="row">
								...
								<div class="col-lg-3">
									<input type="text" name="servicename" class="form-control m-input">
								...
								<div class="col-lg-3">
									<input type="text" name="servicedescription" class="form-control m-input">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<input type="text" name="serviceprice" class="form-control m-input">
