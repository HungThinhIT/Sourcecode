...
<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
	...
	<li class="m-nav__item">
		<a href="{{ route('spa_showListCustomerMember') }}" class="m-nav__link">
			<span class="m-nav__link-text">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<button class="btn btn-danger m-btn m-btn--icon btn-sm m-btn--icon-only  m-btn--pill" data-toggle="modal" data-target="#modal_del" data-url="{{route('spa_deleteCustomerMember',['id'=>$value->CustomerMemberId])}}" data-title="{{$value->CustomerMemberName}}" title="Xoá">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">
					Xác nhận xoá khách hàng <b><span id="title-md-del"></span></b>
				</h5>
			</div>
