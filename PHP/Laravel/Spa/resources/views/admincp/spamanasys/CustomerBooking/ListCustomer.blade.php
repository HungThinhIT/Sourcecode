		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">
					Xác nhận huỷ dịch vụ của khách hàng <b><span id="title-md-del"></span></b>
				</h5>
			</div>
    ...
    var t = function() {
        var t = {
                ...
                // }, 
                {
                    ...
                    overflow: "visible",
                    template: function(t) {
                        return '<a href="{{route('spa_showDetailCustomer',['id'=> ''])}}/'+t.CustomerBookingId+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t<button class="btn btn-danger m-btn m-btn--icon btn-sm m-btn--icon-only  m-btn--pill" data-toggle="modal" data-target="#modal_del" data-url="{{route('spa_cancelCustomer',['id'=>''])}}/'+t.CustomerBookingId+'" data-title="'+t.CustomerName+'" title="Xoá"><i class="fa fa-close"></i></button>'
                    }
                },{
                    field: "Thanh toán",
                    title: "Thanh toán",
